...
TERMS_TO_SPLIT: list[re.Pattern] = [
    ...
    re.compile(r"(Blob)(Desc|Adapter)", flags=re.IGNORECASE),
    re.compile(r"(Bundle)(Not)(Supported)", flags=re.IGNORECASE),
    re.compile(r"(Buffer)(References|Reference)", flags=re.IGNORECASE),
    re.compile(r"(Cache)(Session|Control|Full)", flags=re.IGNORECASE),
    re.compile(r"(Cached)(Size|Session)", flags=re.IGNORECASE),
    re.compile(r"(Class)(Change)", flags=re.IGNORECASE),
    re.compile(r"(Clear)(View|Value)", flags=re.IGNORECASE),
    re.compile(r"(Command)(Allocator|Queue|List|Recorder|Pools|Pool)", flags=re.IGNORECASE),
    re.compile(r"(Copy|Update)(Tile|Texture|Buffer)", flags=re.IGNORECASE),
    ...
    re.compile(r"(Dst)(Coordinates|Region|Placement|Format|Offset|Dimensions|Type|Range)", flags=re.IGNORECASE),
    ...
    re.compile(r"(Out)(Of)(Memory|Bounds|Order)", flags=re.IGNORECASE),
    ...
    re.compile(r"(Pipeline)(State|States|Library)", flags=re.IGNORECASE),
    ...
    re.compile(r"(Read)(From|Back)", flags=re.IGNORECASE),
    ...
    re.compile(r"(Src)(Blend|Type|Offset|Dimensions|Format|Placement|Region|Boxes|Box|Range)", flags=re.IGNORECASE),
    ...
    re.compile(r"(Sub)(Object)", flags=re.IGNORECASE),
    re.compile(r"(Sub)(Resources|Resource)", flags=re.IGNORECASE),
