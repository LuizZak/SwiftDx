...
public extension DxConservativeRasterizationTier {
    ...
    static let tier_1 = D3D12_CONSERVATIVE_RASTERIZATION_TIER_1
    
    static let tier_2 = D3D12_CONSERVATIVE_RASTERIZATION_TIER_2
    
    static let tier_3 = D3D12_CONSERVATIVE_RASTERIZATION_TIER_3
}
