...
typealias DxTessellatorPartitioning = D3D_TESSELLATOR_PARTITIONING

public extension DxTessellatorPartitioning {
    static let undefined = D3D_TESSELLATOR_PARTITIONING_UNDEFINED
    
    static let integer = D3D_TESSELLATOR_PARTITIONING_INTEGER
    
    static let pow2 = D3D_TESSELLATOR_PARTITIONING_POW2
    
    static let fractionalOdd = D3D_TESSELLATOR_PARTITIONING_FRACTIONAL_ODD
