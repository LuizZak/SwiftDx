...
typealias DxTessellatorOutputPrimitive = D3D_TESSELLATOR_OUTPUT_PRIMITIVE

public extension DxTessellatorOutputPrimitive {
    static let undefined = D3D_TESSELLATOR_OUTPUT_UNDEFINED
    
    static let point = D3D_TESSELLATOR_OUTPUT_POINT
    
    static let line = D3D_TESSELLATOR_OUTPUT_LINE
    
    static let triangleCw = D3D_TESSELLATOR_OUTPUT_TRIANGLE_CW
