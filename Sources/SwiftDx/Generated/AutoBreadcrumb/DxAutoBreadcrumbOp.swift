...
public extension DxAutoBreadcrumbOp {
    ...
    static let beginevent = D3D12_AUTO_BREADCRUMB_OP_BEGINEVENT
    
    static let endevent = D3D12_AUTO_BREADCRUMB_OP_ENDEVENT
    ...
    static let endsubmission = D3D12_AUTO_BREADCRUMB_OP_ENDSUBMISSION
    
    static let decodeframe = D3D12_AUTO_BREADCRUMB_OP_DECODEFRAME
    ...
    static let processframes1 = D3D12_AUTO_BREADCRUMB_OP_PROCESSFRAMES1
    ...
    static let dispatchrays = D3D12_AUTO_BREADCRUMB_OP_DISPATCHRAYS
    
    static let initializemetacommand = D3D12_AUTO_BREADCRUMB_OP_INITIALIZEMETACOMMAND
    
    static let executemetacommand = D3D12_AUTO_BREADCRUMB_OP_EXECUTEMETACOMMAND
