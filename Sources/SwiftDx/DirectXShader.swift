...
public class DirectXShader {
    ...
    public func addInput(_ input: D3D12_INPUT_ELEMENT_DESC) {
        inputs.append(input)
    }
    ...
    public struct Flags: OptionSet {
        ...
        public static let debug = Self(rawValue: UINT(D3DCOMPILE_DEBUG))

        /// Do not validate the generated code against known capabilities and
        /// constraints. This option is only recommended when compiling shaders
        /// you KNOW will work. (ie. have compiled before without this option.)
        /// Shaders are always validated by D3D before they are set to the device.
        public static let skipValidation = Self(rawValue: UINT(D3DCOMPILE_SKIP_VALIDATION))

        /// Instructs the compiler to skip optimization steps during code generation.
        /// Unless you are trying to isolate a problem in your code using this option
        /// is not recommended.
        public static let skipOptimization = Self(rawValue: UINT(D3DCOMPILE_SKIP_OPTIMIZATION))

        /// Unless explicitly specified, matrices will be packed in row-major order
        /// on input and output from the shader.
        public static let packMatrixRowMajor = Self(rawValue: UINT(D3DCOMPILE_PACK_MATRIX_ROW_MAJOR))

        /// Unless explicitly specified, matrices will be packed in column-major
        /// order on input and output from the shader.  This is generally more
        /// efficient, since it allows vector-matrix multiplication to be performed
        /// using a series of dot-products.
        public static let packMatrixColumnMajor = Self(rawValue: UINT(D3DCOMPILE_PACK_MATRIX_COLUMN_MAJOR))

        /// Force all computations in resulting shader to occur at partial precision.
        /// This may result in faster evaluation of shaders on some hardware.
        public static let partialPrecision = Self(rawValue: UINT(D3DCOMPILE_PARTIAL_PRECISION))

        /// Force compiler to compile against the next highest available software
        /// target for vertex shaders. This flag also turns optimizations off,
        /// and debugging on.
        public static let forceVsSoftwareNoOpt = Self(rawValue: UINT(D3DCOMPILE_FORCE_VS_SOFTWARE_NO_OPT))

        /// Force compiler to compile against the next highest available software
        /// target for pixel shaders. This flag also turns optimizations off,
        /// and debugging on.
        public static let forcePsSoftwareNoOpt = Self(rawValue: UINT(D3DCOMPILE_FORCE_PS_SOFTWARE_NO_OPT))

        /// Disables Pre-shaders. Using this flag will cause the compiler to not
        /// pull out static expression for evaluation on the host cpu
        public static let noPreshader = Self(rawValue: UINT(D3DCOMPILE_NO_PRESHADER))

        /// Hint compiler to avoid flow-control constructs where possible.
        public static let avoidFlowControl = Self(rawValue: UINT(D3DCOMPILE_AVOID_FLOW_CONTROL))

        /// Hint compiler to prefer flow-control constructs where possible.
        public static let preferFlowControl = Self(rawValue: UINT(D3DCOMPILE_PREFER_FLOW_CONTROL))
        ...
        public static let enableStrictness = Self(rawValue: UINT(D3DCOMPILE_ENABLE_STRICTNESS))

        /// This enables older shaders to compile to 4_0 targets.
        public static let enableBackwardsCompatibility = Self(rawValue: UINT(D3DCOMPILE_ENABLE_BACKWARDS_COMPATIBILITY))

        /// Forces the IEEE strict compile.
        public static let ieeeStrictness = Self(rawValue: UINT(D3DCOMPILE_IEEE_STRICTNESS))
        ...
        /// iteratively
        public static let optimizationLevel0 = Self(rawValue: UINT(D3DCOMPILE_OPTIMIZATION_LEVEL0))

        /// Directs the compiler to use the second lowest optimization level.
        public static let optimizationLevel1 = Self(rawValue: UINT(D3DCOMPILE_OPTIMIZATION_LEVEL1))

        /// Directs the compiler to use the second highest optimization level.
        public static let optimizationLevel2 = Self(rawValue: UINT(D3DCOMPILE_OPTIMIZATION_LEVEL2))
        ...
        public static let optimizationLevel3 = Self(rawValue: UINT(D3DCOMPILE_OPTIMIZATION_LEVEL3))
        ...
        public static let warningsAreErrors = Self(rawValue: UINT(D3DCOMPILE_WARNINGS_ARE_ERRORS))

        /// Directs the compiler to assume that unordered access views (UAVs)
        /// and shader resource views (SRVs) may alias for cs_5_0.
        public static let resourcesMayAlias = Self(rawValue: UINT(D3DCOMPILE_RESOURCES_MAY_ALIAS))

        /// Directs the compiler to enable unbounded descriptor tables.
        public static let enableUnboundedDescriptorTables = Self(rawValue: UINT(D3DCOMPILE_ENABLE_UNBOUNDED_DESCRIPTOR_TABLES))

        /// Directs the compiler to ensure all resources are bound.
        public static let allResourcesBound = Self(rawValue: UINT(D3DCOMPILE_ALL_RESOURCES_BOUND))
        ...
        public static let debugNameForSource = Self(rawValue: UINT(D3DCOMPILE_DEBUG_NAME_FOR_SOURCE))

        /// This enables a debug name to be generated based on compiled information.
        /// It requires `Flags.debug` to be set, and is exclusive with
        /// `Flags.debugNameForSource`.
        public static let debugNameForBinary = Self(rawValue: UINT(D3DCOMPILE_DEBUG_NAME_FOR_BINARY))
    }
}
...
public class DirectXCompiledShader {
    ...
    public init(shader: DirectX.Blob, errorMessage: String?) {
        self.shader = shader
...
public enum PixelShaderVersion: String {
    case v5_0 = "5_0"
}

/// Vertex shader target version
public enum VertexShaderVersion: String {
    case v5_0 = "5_0"
}
