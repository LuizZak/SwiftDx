...
public extension D2DirectionalblurProp {
    ...
    static let optimization = D2D1_DIRECTIONALBLUR_PROP_OPTIMIZATION
    
    static let borderMode = D2D1_DIRECTIONALBLUR_PROP_BORDER_MODE
    
    static let forceDword = D2D1_DIRECTIONALBLUR_PROP_FORCE_DWORD
}
