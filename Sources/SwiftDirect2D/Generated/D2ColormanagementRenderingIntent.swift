...
public extension D2ColormanagementRenderingIntent {
    ...
    static let saturation = D2D1_COLORMANAGEMENT_RENDERING_INTENT_SATURATION
    
    static let absoluteColorimetric = D2D1_COLORMANAGEMENT_RENDERING_INTENT_ABSOLUTE_COLORIMETRIC
    
    static let forceDword = D2D1_COLORMANAGEMENT_RENDERING_INTENT_FORCE_DWORD
}
